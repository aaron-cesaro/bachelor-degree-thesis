...
Una \textit{private testnet} 

\subsubsection{Creazione}

La crezione di una \textit{testnet} di tipo \textit{private} è diventato un processo relativamente semplice negli ultimi due anni, grazie soprattutto all'elevato numero di \textit{tools} sviluppati ed al continuo miglioramento e semplificazione delle funzionalità associate.

\subsubsubsection{Strumenti utilizzati}
