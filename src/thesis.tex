...
L'interesse dimostrato nelle mie capacità, ancor prima che potessi effettivamente iniziare il tirocinio, mi ha dato inoltre la motivazione necessario a transferirmi all'estero (più precisamente in Svizzera) per intraprendere questa fantastica esperienza.\\
Il progetto proposto, oltre a permettermi di toccare con mano una realtà così differente da quella a cui ero abituato durante gli studi universitari, mi ha permesso di apprendere un metodo di lavoro e mi ha aiutato a capire ciò che realmente mi appassiona.
