...
L'\textit{EVM} utilizza una serie di istruzioni (al momento sono 140) necessarie all'esecuzione di attività specifiche.\\
Poiché gli \textit{opcode} hanno dimensione pari ad un (1) byte, possono esistere un massimo di 256 diversi codici operativi.
...
Durante l'esecuzione il \textit{bytecode} è diviso in bytes.\\
%----------------------------------------------------------------------------------------
%	FIGURA 5
%----------------------------------------------------------------------------------------
\begin{figure}[h]\hfill
